...
- Railway deploy: pending for the early payment-shortcut update. Previous verified deployment: 87e38d98-bdcf-47a6-8da7-0407504d2e27.
- Latest live code commit: pending early payment-shortcut deploy. Previous live commit: ce68151 Expose compact payment shortcut in 402 body.
- Latest GitHub release: pending early-payment-shortcut-v1. Previous release: payment-shortcut-v1.
