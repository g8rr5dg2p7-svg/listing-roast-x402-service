...
const INDEXED_QUICK_SCORE_CHALLENGE_DESCRIPTION = "Paid API Listing Quality Score by Listing Roast: $0.001 GET /api/listing-roast for listing quality score API, paid API listing quality score, marketplace product listing quality, Agentic.Market listing score, AgentCore x402 payments, Coinbase x402 Bazaar MCP server buyers, marketplace conversion API, agent listing conversion score, buyer-agent skip reasons, buyer agent skip reasons, agent service clarity, x402 discovery audit, x402 site audit, paid API preflight, route health, stale Bazaar price; GET /api/full-listing-roast upgrade.";
