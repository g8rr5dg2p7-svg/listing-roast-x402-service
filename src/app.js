...
const INDEXED_QUICK_SCORE_CHALLENGE_DESCRIPTION = "Paid API listing quality score, marketplace conversion API, x402 marketplace conversion, buyer-agent skip reasons, site audit, preflight, seller growth checklist. $0.001 GET /api/listing-roast; POST upgrade.";
...
const DISCOVERY_METADATA_VERSION = "2026-06-20-buyer-term-frontload-v1";
const DISCOVERY_METADATA_UPDATED_AT = "2026-06-20T09:05:00.000Z";
...
const CHALLENGE_ROUTE_SERVICE_TAGS = Object.freeze({
  indexedQuickScore: ["x402", "paid API listing quality score", "marketplace listing score", "marketplace listing conversion API", "buyer-agent skip reasons", "x402 marketplace conversion", "x402 seller growth checklist"],
