...
describe("Listing Roast x402 service", () => {
  ...
  it("serves public metadata without payment", async () => {
    ...
    try {
      ...
      expect(mcpInitialize.json.result.serverInfo.version).toBe("2026-06-20-quick-route-conversion-handoff-v44");
      ...
      expect((await compressedX402Manifest.json()).metadataVersion).toBe("2026-06-20-quick-route-conversion-handoff-v44");
      ...
      expect(x402Manifest.json.metadataVersion).toBe("2026-06-20-quick-route-conversion-handoff-v44");
      expect(x402Manifest.json.metadataUpdatedAt).toBe("2026-06-21T02:45:00.000Z");
      ...
      expect(examples.json.payNow.metadataVersion).toBe("2026-06-20-quick-route-conversion-handoff-v44");
      ...
      expect(payNowPaidApiListingQuality.json.metadataVersion).toBe("2026-06-20-quick-route-conversion-handoff-v44");
  ...
  it("serves common agent docs and OpenAPI aliases without payment", async () => {
    ...
    try {
      ...
      expect(paymentAlias.json.metadataVersion).toBe("2026-06-20-quick-route-conversion-handoff-v44");
