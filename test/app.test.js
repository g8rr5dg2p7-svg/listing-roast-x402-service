...
let testDataDir;
const QUICK_SCORE_ALIAS_PATHS = ["/api/marketplace-listing-score", "/api/paid-api-listing-quality", "/api/buyer-agent-skip-reasons", "/api/agent-service-clarity"];
const PREFLIGHT_ALIAS_PATHS = ["/api/preflight", "/api/v1/preflight", "/preflight"];
const PAID_RESOURCE_COUNT = 21;
...
describe("Listing Roast x402 service", () => {
  it("serves public metadata without payment", async () => {
    ...
    try {
      ...
      expect(mcp.json.payNowExamples.skipReasons.route).toContain("/api/buyer-agent-skip-reasons");
      expect(mcp.json.payNowExamples.skipReasons.selectedFirstPaidAction.path).toBe("/api/buyer-agent-skip-reasons");
      expect(mcp.json.payNowExamples.skipReasons.paidResponsePreview.route).toBe("/api/buyer-agent-skip-reasons");
      expect(mcp.json.payNowExamples.skipReasons.selectedFirstPaidResponsePreview.route).toBe("/api/buyer-agent-skip-reasons");
      ...
      expect(mcpServerCard.json.payment.payNowExamples.skipReasons.route).toContain("/api/buyer-agent-skip-reasons");
      expect(mcpServerCard.json.payment.payNowExamples.skipReasons.selectedFirstPaidAction.path).toBe("/api/buyer-agent-skip-reasons");
      ...
      expect(x402Manifest.json.metadataVersion).toBe("2026-06-19-buyer-skip-alias-first-v1");
      expect(x402Manifest.json.metadataUpdatedAt).toBe("2026-06-19T22:35:24.000Z");
      ...
      expect(x402Manifest.json.payNowExamples.skipReasons.selectedFirstPaidAction.path).toBe("/api/buyer-agent-skip-reasons");
      expect(x402Manifest.json.payNowExamples.skipReasons.paidResponsePreview.route).toBe("/api/buyer-agent-skip-reasons");
      expect(x402Manifest.json.payNowExamples.skipReasons.selectedFirstPaidResponsePreview.route).toBe("/api/buyer-agent-skip-reasons");
      ...
      expect(x402Manifest.json.intentLandingPages.map((page) => page.path)).toEqual(["/paid-api-listing-quality", "/buyer-agent-skip-reasons", "/agent-service-clarity", "/agent-listing-conversion", "/x402-discovery-audit", "/x402-site-audit"]);
      ...
      expect(x402Manifest.json.intentLandingPages[1].primaryPaidAction.path).toBe("/api/buyer-agent-skip-reasons");
      expect(x402Manifest.json.intentLandingPages[2].primaryPaidAction.path).toBe("/api/agent-service-clarity");
      expect(x402Manifest.json.intentLandingPages[4].primaryPaidAction.path).toBe("/api/x402-discovery-audit");
      expect(x402Manifest.json.intentLandingPages[4].primaryPaidAction.method).toBe("GET");
      expect(x402Manifest.json.intentLandingPages[4].primaryPaidAction.maxAmountRequired).toBe("1000");
      expect(x402Manifest.json.resources.map((resource) => resource.id)).toEqual(["indexed_roast_quick_score", "marketplace_listing_score_alias", "paid_api_listing_quality_alias", "buyer_agent_skip_reasons_alias", "agent_service_clarity_alias", "directory_root_post", "api_entry", "api_v1_entry", "v1_entry", "instant_listing_score", "x402_marketplace_conversion_score", "agent_listing_conversion_score", "x402_ping", "x402_site_audit", "paid_api_preflight", "api_v1_paid_api_preflight", "root_paid_api_preflight", "x402_discovery_audit_quick", "x402_discovery_audit", "listing_score", "listing_roast"]);
      ...
      expect(x402Manifest.json.resources[0].description).toMatch(/^Paid API listing quality score/);
      ...
      expect(x402Manifest.json.resources[0].description).toContain("x402 audit");
      ...
      expect(agentTools.json.metadata_version).toBe("2026-06-19-buyer-skip-alias-first-v1");
      expect(agentTools.json.metadata_updated_at).toBe("2026-06-19T22:35:24.000Z");
      ...
      expect(agentTools.json.intent_landing_pages.map((page) => page.path)).toEqual(["/paid-api-listing-quality", "/buyer-agent-skip-reasons", "/agent-service-clarity", "/agent-listing-conversion", "/x402-discovery-audit", "/x402-site-audit"]);
      expect(agentTools.json.intent_landing_pages[1].primaryPaidAction.path).toBe("/api/buyer-agent-skip-reasons");
      expect(agentTools.json.intent_landing_pages[2].primaryPaidAction.path).toBe("/api/agent-service-clarity");
      ...
      expect(aiPlugin.json.x_listing_roast.payNowExamples.skipReasons.selectedFirstPaidResponsePreview.route).toBe("/api/buyer-agent-skip-reasons");
      ...
      expect(examples.json.payNowExamples.skipReasons.selectedFirstPaidAction.path).toBe("/api/buyer-agent-skip-reasons");
      ...
      expect(examples.json.findExamples.skipReasons.recommended.path).toBe("/api/buyer-agent-skip-reasons");
      ...
      expect(examples.json.routeExamples.skipReasons.results[0].path).toBe("/api/buyer-agent-skip-reasons");
      ...
      expect(openApi.json.paths["/api/listing-roast"].get.description).toContain("Score API marketplace listing quality and discoverability");
      ...
      expect(payNowSkipReasons.json.route).toContain("/api/buyer-agent-skip-reasons");
      ...
      expect(payNowSkipReasons.json.command).toContain("/api/buyer-agent-skip-reasons");
      expect(payNowSkipReasons.json.expectedChallenge.amount).toBe("1000");
      expect(payNowSkipReasons.json.expectedChallenge.route).toContain("/api/buyer-agent-skip-reasons");
      expect(payNowSkipReasons.json.selectedPaidAction.path).toBe("/api/buyer-agent-skip-reasons");
      expect(payNowSkipReasons.json).not.toHaveProperty("exactIntentPaidAction");
      expect(payNowSkipReasons.json.selectedFirstPaidAction.path).toBe("/api/buyer-agent-skip-reasons");
      expect(payNowSkipReasons.json.selectedPaidSequence[0].use).toBe("buyerAgentSkipReasons");
      expect(payNowSkipReasons.json.selectedPaidSequence[0].action.path).toBe("/api/buyer-agent-skip-reasons");
      ...
      expect(payNowSkipReasons.json.selectedFirstPaidResponsePreview.route).toBe("/api/buyer-agent-skip-reasons");
      expect(payNowSkipReasons.json.buyerInstruction).toContain("start with GET /api/buyer-agent-skip-reasons");
      expect(payNowSkipReasons.json.buyerInstruction).toContain("Use GET /api/listing-roast when");
      ...
      expect(payNowSkipReasons.json.rankedPaidRoutes[0].id).toBe("buyer_agent_skip_reasons_alias");
      ...
      expect(payNowPaidApiListingQuality.json.rankedPaidRoutes[0].id).toBe("paid_api_listing_quality_alias");
      ...
      expect(payNowMarketplaceListingScore.json.rankedPaidRoutes[0].id).toBe("marketplace_listing_score_alias");
      ...
      expect(payNowAgentServiceClarity.json.rankedPaidRoutes[0].id).toBe("agent_service_clarity_alias");
      ...
      expect(findSkipReasons.json.recommended.path).toBe("/api/buyer-agent-skip-reasons");
      ...
      expect(findSkipReasons.json).not.toHaveProperty("exactIntentPaidAction");
      expect(findSkipReasons.json.selectedFirstPaidAction.path).toBe("/api/buyer-agent-skip-reasons");
      expect(findSkipReasons.json.selectedPaidSequence[0].use).toBe("buyerAgentSkipReasons");
      expect(findSkipReasons.json.selectedPaidSequence[0].action.path).toBe("/api/buyer-agent-skip-reasons");
      expect(findSkipReasons.json.paidResponsePreview.route).toBe("/api/buyer-agent-skip-reasons");
      expect(findSkipReasons.json.selectedFirstPaidResponsePreview.route).toBe("/api/buyer-agent-skip-reasons");
      expect(findSkipReasons.json.buyerInstruction).toContain("start with GET /api/buyer-agent-skip-reasons");
      expect(findSkipReasons.json.alternatives.map((route) => route.path)).toContain("/api/listing-roast");
      ...
      expect(findMixedSkipReasons.json.recommended.path).toBe("/api/buyer-agent-skip-reasons");
      ...
      expect(routeSkipReasons.json.best.path).toBe("/api/buyer-agent-skip-reasons");
      ...
      expect(routeSkipReasons.json).not.toHaveProperty("exactIntentPaidAction");
      expect(routeSkipReasons.json.selectedFirstPaidAction.path).toBe("/api/buyer-agent-skip-reasons");
      expect(routeSkipReasons.json.selectedPaidSequence[0].use).toBe("buyerAgentSkipReasons");
      expect(routeSkipReasons.json.selectedPaidSequence[0].action.path).toBe("/api/buyer-agent-skip-reasons");
      expect(routeSkipReasons.json.buyerInstruction).toContain("start with GET /api/buyer-agent-skip-reasons");
      expect(routeSkipReasons.json.results).toHaveLength(2);
      expect(routeSkipReasons.json.results.map((route) => route.path)).toContain("/api/listing-roast");
      ...
      expect(routeMixedSkipReasons.json.best.path).toBe("/api/buyer-agent-skip-reasons");
      expect(routeMixedSkipReasons.json.results.map((route) => route.path)).toContain("/api/agent-service-clarity");
      ...
      expect(localDiscoveryListingScoreSearch.json.resources[0].metadata.path).toBe("/api/marketplace-listing-score");
      ...
      expect(localDiscoveryListingQualitySearch.json.resources[0].metadata.path).toBe("/api/paid-api-listing-quality");
      ...
      expect(localDiscoveryMarketplaceQualitySearch.json.resources[0].metadata.path).toBe("/api/marketplace-listing-score");
      ...
      expect(localDiscoverySkipReasonsSearch.json.resources[0].metadata.path).toBe("/api/buyer-agent-skip-reasons");
      ...
      expect(localDiscoverySkipReasonsSearch.json).not.toHaveProperty("exactIntentPaidAction");
      expect(localDiscoverySkipReasonsSearch.json.selectedFirstPaidAction.path).toBe("/api/buyer-agent-skip-reasons");
      expect(localDiscoverySkipReasonsSearch.json.selectedPaidSequence[0].use).toBe("buyerAgentSkipReasons");
      expect(localDiscoverySkipReasonsSearch.json.selectedPaidSequence[0].action.path).toBe("/api/buyer-agent-skip-reasons");
      expect(localDiscoverySkipReasonsSearch.json.paidResponsePreview.route).toBe("/api/buyer-agent-skip-reasons");
      expect(localDiscoverySkipReasonsSearch.json.selectedFirstPaidResponsePreview.route).toBe("/api/buyer-agent-skip-reasons");
      expect(localDiscoverySkipReasonsSearch.json.buyerInstruction).toContain("start with GET /api/buyer-agent-skip-reasons");
      ...
      expect(localDiscoveryAgentClaritySearch.json.resources[0].metadata.path).toBe("/api/agent-service-clarity");
      ...
      expect(cashRegister.json.signals.schemaViews).toBe(3);
  ...
  it("protects the indexed listing-roast GET route with a one-tenth-cent x402 challenge", async () => {
    ...
    try {
      ...
      expect(challenge.error).toBe("Payment required");
      expect(challenge.resource.url).toContain("/api/listing-roast");
      expect(challenge.resource.description).toMatch(/^Paid API listing quality score/);
      expect(challenge.resource.description).toContain("$0.001");
      expect(challenge.resource.description).toContain("x402 audit");
      expect(challenge.resource.description).toContain("buyer-agent skip reasons");
