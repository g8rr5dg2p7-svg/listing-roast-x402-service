...
describe("Listing Roast x402 service", () => {
  it("serves public metadata without payment", async () => {
    ...
    try {
      ...
      expect(x402Manifest.json.metadataVersion).toBe("2026-06-19-agent-tools-resource-sample-v1");
      expect(x402Manifest.json.metadataUpdatedAt).toBe("2026-06-19T19:25:00.000Z");
      ...
      expect(agentTools.json.metadata_version).toBe("2026-06-19-agent-tools-resource-sample-v1");
      expect(agentTools.json.metadata_updated_at).toBe("2026-06-19T19:25:00.000Z");
      ...
      expect(openApi.json.paths["/api/x402-discovery-audit"].get["x-payment"].paidUsageProof).toContain("/api/pay-now");
      ...
      expect(openApi.json.paths["/api/listing-roast"].get["x-payment"].paidUsageProof).toContain("/api/pay-now");
      ...
      expect(cashRegister.json.signals.payNowViews).toBe(14);
