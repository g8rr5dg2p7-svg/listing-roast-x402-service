...
describe("Listing Roast x402 service", () => {
  it("serves public metadata without payment", async () => {
    ...
    try {
      ...
      expect(mcp.json.tools[4].command).toContain("/api/agent-listing-conversion");
      expect(mcp.json.tools[4].command).toContain("--max-amount 1000");
      expect(mcp.json.tools[7].command).toContain("/api/x402-discovery-audit");
      expect(mcp.json.tools[7].command).toContain("--max-amount 10000");
      ...
      expect(mcp.json.tools.map((tool) => tool.path)).toEqual(["/api/listing-roast", "/api", "/api/instant-listing-score", "/api/x402-marketplace-conversion", "/api/agent-listing-conversion", "/api/x402-ping", "/api/x402-site-audit", "/api/x402-discovery-audit", "/api/listing-score", "/api/listing-roast"]);
      ...
      expect(x402Manifest.json.capabilities.tools).toBe(10);
      ...
      expect(x402Manifest.json.resources.map((resource) => resource.id)).toEqual(["indexed_roast_quick_score", "api_entry", "instant_listing_score", "x402_marketplace_conversion_score", "agent_listing_conversion_score", "x402_ping", "x402_site_audit", "x402_discovery_audit", "listing_score", "listing_roast"]);
      expect(x402Manifest.json.resources.map((resource) => resource.path)).toEqual(["/api/listing-roast", "/api", "/api/instant-listing-score", "/api/x402-marketplace-conversion", "/api/agent-listing-conversion", "/api/x402-ping", "/api/x402-site-audit", "/api/x402-discovery-audit", "/api/listing-score", "/api/listing-roast"]);
      ...
      expect(x402Manifest.json.resources[3].keywords).toContain("x402 marketplace conversion");
      expect(x402Manifest.json.resources[3].maxAmountRequired).toBe("1000");
      expect(x402Manifest.json.resources[4].price).toBe("$0.001");
      expect(x402Manifest.json.resources[4].keywords).toContain("agent service listing clarity");
      expect(x402Manifest.json.resources[4].keywords).toContain("buyer-agent skip reasons");
      expect(x402Manifest.json.resources[4].maxAmountRequired).toBe("1000");
      expect(x402Manifest.json.resources[5].price).toBe("$0.001");
      expect(x402Manifest.json.resources[5].keywords).toContain("x402 ping");
      expect(x402Manifest.json.resources[5].maxAmountRequired).toBe("1000");
      expect(x402Manifest.json.resources[6].price).toBe("$0.001");
      expect(x402Manifest.json.resources[6].keywords).toContain("x402 site audit");
      expect(x402Manifest.json.resources[6].keywords).toContain("paid API preflight");
      expect(x402Manifest.json.resources[6].keywords).toContain("x402 route health check");
      expect(x402Manifest.json.resources[6].maxAmountRequired).toBe("1000");
      expect(x402Manifest.json.resources[7].price).toBe("$0.01");
      expect(x402Manifest.json.resources[7].keywords).toContain("x402 bazaar discovery audit");
      expect(x402Manifest.json.resources[7].maxAmountRequired).toBe("10000");
      expect(x402Manifest.json.resources[8].price).toBe("$0.005");
      expect(x402Manifest.json.resources[8].maxAmountRequired).toBe("5000");
      expect(x402Manifest.json.resources[9].price).toBe("$0.01");
      expect(x402Manifest.json.resources[9].maxAmountRequired).toBe("10000");
      ...
      expect(wellKnownX402Manifest.json.resources[2].command).toContain("/api/instant-listing-score");
      expect(wellKnownX402Manifest.json.resources[3].command).toContain("/api/x402-marketplace-conversion");
      expect(wellKnownX402Manifest.json.resources[4].command).toContain("/api/agent-listing-conversion");
      expect(wellKnownX402Manifest.json.resources[5].command).toContain("/api/x402-ping");
      expect(wellKnownX402Manifest.json.resources[6].command).toContain("/api/x402-site-audit");
      expect(wellKnownX402Manifest.json.resources[7].command).toContain("/api/x402-discovery-audit");
      expect(wellKnownX402Manifest.json.resources[9].command).toContain("--max-amount 10000");
      ...
      expect(agentCard.json.supportedInterfaces.map((item) => item.transport)).toEqual(["HTTP+JSON", "HTTP+JSON", "OPENAPI", "X402", "MCP", "MCP-SERVER-CARD"]);
      expect(agentCard.json.additionalInterfaces.map((item) => item.transport)).toEqual(["HTTP+JSON", "HTTP+JSON", "OPENAPI", "X402", "MCP", "MCP-SERVER-CARD"]);
      ...
      expect(agentCard.json.skills[4].examples[0]).toContain("/api/x402-discovery-audit");
      expect(agentCard.json.skills[4].metadata.maxAmountRequired).toBe("10000");
