...
describe("Listing Roast x402 service", () => {
  it("serves public metadata without payment", async () => {
    ...
    try {
      ...
      expect((await compressedX402Manifest.json()).metadataVersion).toBe("2026-06-20-api-catalog-command-handoff-v1");
      ...
      expect(x402Manifest.json.metadataVersion).toBe("2026-06-20-api-catalog-command-handoff-v1");
      expect(x402Manifest.json.metadataUpdatedAt).toBe("2026-06-20T07:22:48.000Z");
      ...
      expect(x402Manifest.json.resources[0].description).toMatch(/^Score API marketplace listing quality and discoverability/);
      expect(x402Manifest.json.resources[0].description).toContain("Score marketplace listings for conversion");
      expect(x402Manifest.json.resources[0].description).toContain("metadata quality");
      expect(x402Manifest.json.resources[0].description).toContain("pricing clarity");
      expect(x402Manifest.json.resources[0].description).toContain("buyer intent");
      expect(x402Manifest.json.resources[0].description).toContain("keyword coverage");
      ...
      expect(agentTools.json.metadata_version).toBe("2026-06-20-api-catalog-command-handoff-v1");
      expect(agentTools.json.metadata_updated_at).toBe("2026-06-20T07:22:48.000Z");
      ...
      expect(agentSkills.json.metadataVersion).toBe("2026-06-20-api-catalog-command-handoff-v1");
  ...
  it("serves common agent docs and OpenAPI aliases without payment", async () => {
    ...
    try {
      ...
      expect(paymentAlias.json.metadataVersion).toBe("2026-06-20-api-catalog-command-handoff-v1");
  ...
  it("protects the indexed listing-roast GET route with a one-tenth-cent x402 challenge", async () => {
    ...
    try {
      ...
      expect(challenge.error).toBe("Payment required");
      expect(challenge.resource.url).toContain("/api/listing-roast");
      expect(challenge.resource.description).toMatch(/^Score API marketplace listing quality and discoverability/);
      expect(challenge.resource.description).toContain("Score marketplace listings for conversion");
      expect(challenge.resource.description).toContain("metadata quality");
      expect(challenge.resource.description).toContain("pricing clarity");
      expect(challenge.resource.description).toContain("buyer intent");
      expect(challenge.resource.description).toContain("keyword coverage");
