...
describe("Listing Roast x402 service", () => {
  ...
  it("records aggregate no-spend intent signals without storing raw queries", async () => {
    ...
    try {
      ...
      expect(findDiscovery.json.metadataVersion).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(findDiscovery.json.metadata_version).toBe("2026-06-21-route-cdp-search-context-v51");
      ...
      expect(routeFullRoast.json.metadataVersion).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(routeFullRoast.json.metadata_version).toBe("2026-06-21-route-cdp-search-context-v51");
      ...
      expect(routeFullRoast.json.results[0].metadata_version).toBe("2026-06-21-route-cdp-search-context-v51");
      ...
      expect(routePreflight.json.metadata_version).toBe("2026-06-21-route-cdp-search-context-v51");
      ...
      expect(localDiscovery.json.metadataVersion).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(localDiscovery.json.metadata_version).toBe("2026-06-21-route-cdp-search-context-v51");
      ...
      expect(localDiscovery.json.resources[0].metadataVersion).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(localDiscovery.json.resources[0].metadata_version).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(localDiscovery.json.resources[0].metadata.serviceName).toBe("Listing Roast x402");
      expect(localDiscovery.json.resources[0].metadata.metadata_version).toBe("2026-06-21-route-cdp-search-context-v51");
  ...
  it("serves public metadata without payment", async () => {
    ...
    try {
      ...
      expect(mcp.json.metadataVersion).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(mcp.json.metadata_version).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(mcp.json.metadataUpdatedAt).toBe("2026-06-21T00:48:56.000Z");
      expect(mcp.json.metadata_updated_at).toBe("2026-06-21T00:48:56.000Z");
      ...
      expect(mcpInitialize.json.result.serverInfo.version).toBe("2026-06-21-route-cdp-search-context-v51");
      ...
      expect(mcpServerCard.json.metadataVersion).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(mcpServerCard.json.metadata_version).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(mcpServerCard.json.metadataUpdatedAt).toBe("2026-06-21T00:48:56.000Z");
      expect(mcpServerCard.json.metadata_updated_at).toBe("2026-06-21T00:48:56.000Z");
      expect(mcpServerCard.json.serverInfo.name).toBe("Listing Roast x402");
      expect(mcpServerCard.json.serverInfo.version).toBe("2026-06-21-route-cdp-search-context-v51");
      ...
      expect((await compressedX402Manifest.json()).metadataVersion).toBe("2026-06-21-route-cdp-search-context-v51");
      ...
      expect(x402Manifest.json.metadataVersion).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(x402Manifest.json.metadataUpdatedAt).toBe("2026-06-21T00:48:56.000Z");
      ...
      expect(agentTools.json.metadataVersion).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(agentTools.json.metadata_version).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(agentTools.json.metadataUpdatedAt).toBe("2026-06-21T00:48:56.000Z");
      expect(agentTools.json.metadata_updated_at).toBe("2026-06-21T00:48:56.000Z");
      ...
      expect(agentCard.json.metadataVersion).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(agentCard.json.metadata_version).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(agentCard.json.metadataUpdatedAt).toBe("2026-06-21T00:48:56.000Z");
      expect(agentCard.json.metadata_updated_at).toBe("2026-06-21T00:48:56.000Z");
      ...
      expect(agentSkills.json.metadataVersion).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(agentSkills.json.metadata_version).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(agentSkills.json.metadataUpdatedAt).toBe("2026-06-21T00:48:56.000Z");
      expect(agentSkills.json.metadata_updated_at).toBe("2026-06-21T00:48:56.000Z");
      ...
      expect(examples.json.payNow.metadataVersion).toBe("2026-06-21-route-cdp-search-context-v51");
      ...
      expect(payNow.json.metadataVersion).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(payNow.json.metadata_version).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(payNow.json.metadataUpdatedAt).toBe("2026-06-21T00:48:56.000Z");
      expect(payNow.json.metadata_updated_at).toBe("2026-06-21T00:48:56.000Z");
      ...
      expect(payNow.json.paidUsageProof.metadataVersion).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(payNow.json.paidUsageProof.metadata_version).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(payNow.json.paidUsageProof.metadataUpdatedAt).toBe("2026-06-21T00:48:56.000Z");
      expect(payNow.json.paidUsageProof.metadata_updated_at).toBe("2026-06-21T00:48:56.000Z");
      ...
      expect(paidUsageProof.json.metadataVersion).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(paidUsageProof.json.metadata_version).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(paidUsageProof.json.metadataUpdatedAt).toBe("2026-06-21T00:48:56.000Z");
      expect(paidUsageProof.json.metadata_updated_at).toBe("2026-06-21T00:48:56.000Z");
      ...
      expect(paidUsageProof.json.paidUsageProof.metadataVersion).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(paidUsageProof.json.paidUsageProof.metadata_version).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(paidUsageProof.json.paidUsageProof.metadataUpdatedAt).toBe("2026-06-21T00:48:56.000Z");
      expect(paidUsageProof.json.paidUsageProof.metadata_updated_at).toBe("2026-06-21T00:48:56.000Z");
      ...
      expect(payNowPaidApiListingQuality.json.metadataVersion).toBe("2026-06-21-route-cdp-search-context-v51");
      ...
      expect(pricing.json.metadataVersion).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(pricing.json.metadata_version).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(pricing.json.metadataUpdatedAt).toBe("2026-06-21T00:48:56.000Z");
      expect(pricing.json.metadata_updated_at).toBe("2026-06-21T00:48:56.000Z");
      expect(pricing.json.noSpend).toBe(true);
      expect(pricing.json.paidUsageProof.serviceName).toBe("Listing Roast x402");
      expect(pricing.json.paidUsageProof.metadata_version).toBe("2026-06-21-route-cdp-search-context-v51");
      ...
      expect(routeDiscovery.json.metadataVersion).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(routeDiscovery.json.metadata_version).toBe("2026-06-21-route-cdp-search-context-v51");
      ...
      expect(routeDiscovery.json.results[0].metadataVersion).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(routeDiscovery.json.results[0].metadata_version).toBe("2026-06-21-route-cdp-search-context-v51");
      ...
      expect(localDiscovery.json.metadataVersion).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(localDiscovery.json.metadata_version).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(localDiscovery.json.metadataUpdatedAt).toBe("2026-06-21T00:48:56.000Z");
      expect(localDiscovery.json.metadata_updated_at).toBe("2026-06-21T00:48:56.000Z");
      ...
      expect(localDiscovery.json.items[0].metadataVersion).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(localDiscovery.json.items[0].metadata_version).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(localDiscovery.json.items[0].metadataUpdatedAt).toBe("2026-06-21T00:48:56.000Z");
      expect(localDiscovery.json.items[0].metadata_updated_at).toBe("2026-06-21T00:48:56.000Z");
      ...
      expect(localDiscovery.json.items[0].metadata.metadataVersion).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(localDiscovery.json.items[0].metadata.metadata_version).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(localDiscovery.json.items[0].metadata.metadataUpdatedAt).toBe("2026-06-21T00:48:56.000Z");
      expect(localDiscovery.json.items[0].metadata.metadata_updated_at).toBe("2026-06-21T00:48:56.000Z");
      ...
      expect(localDiscoverySearch.json.metadataVersion).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(localDiscoverySearch.json.metadata_version).toBe("2026-06-21-route-cdp-search-context-v51");
      ...
      expect(localDiscoverySearch.json.resources[0].metadata_version).toBe("2026-06-21-route-cdp-search-context-v51");
      ...
      expect(localDiscoverySearch.json.resources[0].metadata.metadata_version).toBe("2026-06-21-route-cdp-search-context-v51");
      ...
      expect(localDiscoveryMerchant.json.metadataVersion).toBe("2026-06-21-route-cdp-search-context-v51");
      expect(localDiscoveryMerchant.json.metadata_version).toBe("2026-06-21-route-cdp-search-context-v51");
      ...
      expect(localDiscoveryMerchant.json.resources[0].metadata_version).toBe("2026-06-21-route-cdp-search-context-v51");
  ...
  it("includes receiver wallet proof on the free paid usage proof endpoint", async () => {
    ...
    try {
      ...
      expect(proof.json.metadata_version).toBe("2026-06-21-route-cdp-search-context-v51");
      ...
      expect(proof.json.paidUsageProof.metadata_version).toBe("2026-06-21-route-cdp-search-context-v51");
      ...
      expect(payNowFirstPaid.json.metadata_version).toBe("2026-06-21-route-cdp-search-context-v51");
  ...
  it("serves common agent docs and OpenAPI aliases without payment", async () => {
    ...
    try {
      ...
      expect(paymentAlias.json.metadataVersion).toBe("2026-06-21-route-cdp-search-context-v51");
