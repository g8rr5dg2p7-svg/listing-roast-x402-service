...
describe("Listing Roast x402 service", () => {
  it("serves public metadata without payment", async () => {
    ...
    try {
      ...
      expect(x402Manifest.json.metadataVersion).toBe("2026-06-19-exact-discovery-phrases-v1");
      expect(x402Manifest.json.metadataUpdatedAt).toBe("2026-06-19T21:27:30.000Z");
      ...
      expect(agentTools.json.metadata_version).toBe("2026-06-19-exact-discovery-phrases-v1");
      expect(agentTools.json.metadata_updated_at).toBe("2026-06-19T21:27:30.000Z");
      ...
      expect(payNowPaidApiListingQuality.json.route).toContain("/api/paid-api-listing-quality");
      expect(payNowPaidApiListingQuality.json.command).toContain("/api/paid-api-listing-quality");
      ...
      expect(payNowMarketplaceListingScore.json.route).toContain("/api/marketplace-listing-score");
      ...
      expect(payNowAgentServiceClarity.json.route).toContain("/api/agent-service-clarity");
