...
describe("Listing Roast x402 service", () => {
  it("serves public metadata without payment", async () => {
    ...
    try {
      ...
      expect(mcp.json.payment.officialCdpDiscovery.recommendedSearchUrl).toContain("maxUsdPrice=0.01");
      ...
      expect((await compressedX402Manifest.json()).metadataVersion).toBe("2026-06-20-agent-conversion-search-v1");
      ...
      expect(x402Manifest.json.metadataVersion).toBe("2026-06-20-agent-conversion-search-v1");
      expect(x402Manifest.json.metadataUpdatedAt).toBe("2026-06-20T11:36:12.000Z");
      ...
      expect(x402Manifest.json.intentLandingPages.map((page) => page.path)).toEqual(["/paid-api-listing-quality", "/paid-api-listing-quality-score", "/listing-quality-score-api", "/marketplace-product-listing-quality", "/marketplace-listing-conversion-api", "/marketplace-listing-conversion", "/x402-listing-quality", "/buyer-agent-skip-reasons", "/agent-service-clarity", "/agent-listing-conversion", "/x402-discovery-audit", "/x402-site-audit"]);
      ...
      expect(x402Manifest.json.intentLandingPages[2].primaryPaidAction.path).toBe("/api/listing-quality-score-api");
      expect(x402Manifest.json.intentLandingPages[3].primaryPaidAction.path).toBe("/api/marketplace-product-listing-quality");
      expect(x402Manifest.json.intentLandingPages[4].primaryPaidAction.path).toBe("/api/marketplace-listing-conversion-api");
      expect(x402Manifest.json.intentLandingPages[5].primaryPaidAction.path).toBe("/api/marketplace-listing-conversion-api");
      expect(x402Manifest.json.intentLandingPages[6].primaryPaidAction.path).toBe("/api/x402-listing-quality");
      expect(x402Manifest.json.intentLandingPages[7].primaryPaidAction.path).toBe("/api/buyer-agent-skip-reasons");
      ...
      expect(x402Manifest.json.intentLandingPages[8].primaryPaidAction.path).toBe("/api/agent-service-clarity");
      ...
      expect(x402Manifest.json.resources[0].description).toMatch(/^Listing Roast Quick Score/);
      ...
      expect(agentTools.json.metadata_version).toBe("2026-06-20-agent-conversion-search-v1");
      expect(agentTools.json.metadata_updated_at).toBe("2026-06-20T11:36:12.000Z");
      ...
      expect(agentTools.json.intent_landing_pages.map((page) => page.path)).toEqual(["/paid-api-listing-quality", "/paid-api-listing-quality-score", "/listing-quality-score-api", "/marketplace-product-listing-quality", "/marketplace-listing-conversion-api", "/marketplace-listing-conversion", "/x402-listing-quality", "/buyer-agent-skip-reasons", "/agent-service-clarity", "/agent-listing-conversion", "/x402-discovery-audit", "/x402-site-audit"]);
      expect(agentTools.json.intent_landing_pages[1].primaryPaidAction.path).toBe("/api/paid-api-listing-quality-score");
      expect(agentTools.json.intent_landing_pages[2].primaryPaidAction.path).toBe("/api/listing-quality-score-api");
      expect(agentTools.json.intent_landing_pages[3].primaryPaidAction.path).toBe("/api/marketplace-product-listing-quality");
      expect(agentTools.json.intent_landing_pages[4].primaryPaidAction.path).toBe("/api/marketplace-listing-conversion-api");
      expect(agentTools.json.intent_landing_pages[5].primaryPaidAction.path).toBe("/api/marketplace-listing-conversion-api");
      expect(agentTools.json.intent_landing_pages[6].primaryPaidAction.path).toBe("/api/x402-listing-quality");
      expect(agentTools.json.intent_landing_pages[7].primaryPaidAction.path).toBe("/api/buyer-agent-skip-reasons");
      ...
      expect(agentTools.json.intent_landing_pages[8].primaryPaidAction.path).toBe("/api/agent-service-clarity");
      ...
      expect(agentSkills.json.metadataVersion).toBe("2026-06-20-agent-conversion-search-v1");
      ...
      expect(examples.json.officialCdpDiscovery.recommendedSearchUrl).toContain("maxUsdPrice=0.01");
      ...
      expect(openApi.json.paths["/api/listing-roast"].get.summary).toContain("listing roast quick score");
      ...
      expect(openApi.json.x402.officialCdpDiscovery.recommendedSearchUrl).toContain("query=listing+roast");
      ...
      expect(payNow.json.genericRecommendedPaidSequence[1].use).toBe("fullRoast");
      ...
      expect(commands.json.selectedPaidAction.path).toBe("/api/paid-api-listing-quality");
      ...
      expect(commands.json.genericRecommendedPaidSequence[1].action.method).toBe("POST");
      ...
      expect(commands.json.buyerPhraseCommandPack[0].recommendedPaidSequence[1].action.path).toBe("/api/listing-roast");
      expect(commands.json.buyerPhraseCommandPack[0].upgradeAfterFit.command).toContain("-X POST");
      ...
      expect(commandsFullRoast.json.firstPaidAction.path).toBe("/api/listing-roast");
      expect(commandsFullRoast.json.firstPaidAction.method).toBe("POST");
      expect(commandsFullRoast.json.firstPaidAction.maxAmountRequired).toBe("10000");
      expect(commandsFullRoast.json.firstPaidAction.command).toContain("-X POST");
      ...
      expect(commandsAgentListingConversion.json.firstPaidAction.command).toContain("/api/agent-listing-conversion");
      ...
      expect(payNowMarketplaceListingConversion.json.selectedPaidAction.path).toBe("/api/marketplace-listing-conversion-api");
      ...
      expect(payNowAgentListingConversion.json.route).toContain("/api/agent-listing-conversion");
      expect(payNowAgentListingConversion.json.maxAmountRequired).toBe("1000");
      expect(payNowAgentListingConversion.json.selectedPaidAction.path).toBe("/api/agent-listing-conversion");
      expect(payNowAgentListingConversion.json.selectedFirstPaidAction.path).toBe("/api/agent-listing-conversion");
      expect(payNowAgentListingConversion.json.command).toContain("/api/agent-listing-conversion");
      ...
      expect(findDiscovery.json.genericRecommendedPaidSequence[1].use).toBe("fullRoast");
      ...
      const findAgentListingConversion = await fetchJson(server, "/api/find?q=agent%20listing%20conversion");
      expect(findAgentListingConversion.status).toBe(200);
      expect(findAgentListingConversion.json.recommended.path).toBe("/api/agent-listing-conversion");
      expect(findAgentListingConversion.json.selectedActionKey).toBe("agentListingConversion");
      expect(findAgentListingConversion.json.selectedPaidAction.path).toBe("/api/agent-listing-conversion");
      expect(findAgentListingConversion.json.selectedPaidAction.maxAmountRequired).toBe("1000");
      expect(findAgentListingConversion.json.selectedFirstPaidAction.path).toBe("/api/agent-listing-conversion");
      expect(findAgentListingConversion.json.command).toContain("/api/agent-listing-conversion");
      ...
      expect(findMarketplaceListingConversion.json.selectedPaidAction.path).toBe("/api/marketplace-listing-conversion-api");
      ...
      expect(findFullRewrite.json.startHere.use).toBe("fullRoast");
      expect(findFullRewrite.json.startHere.path).toBe("/api/listing-roast");
      expect(findFullRewrite.json.startHere.method).toBe("POST");
      ...
      expect(findFullRewrite.json.recommendedPaidSequence[0].use).toBe("fullRoast");
      ...
      expect(routeDiscovery.json.genericRecommendedPaidSequence[1].use).toBe("fullRoast");
      ...
      expect(routeFullRewrite.json.best.path).toBe("/api/listing-roast");
      expect(routeFullRewrite.json.best.method).toBe("POST");
      expect(routeFullRewrite.json.selectedActionKey).toBe("fullRoast");
      expect(routeFullRewrite.json.startHere.use).toBe("fullRoast");
      expect(routeFullRewrite.json.startHere.path).toBe("/api/listing-roast");
      expect(routeFullRewrite.json.startHere.method).toBe("POST");
      ...
      expect(routeFullRewrite.json.recommendedPaidSequence[0].use).toBe("fullRoast");
      ...
      const routeAgentListingConversion = await fetchJson(server, "/api/route?query=agent%20listing%20conversion&top=3");
      ...
      expect(routeAgentListingConversion.json.best.path).toBe("/api/agent-listing-conversion");
      expect(routeAgentListingConversion.json.selectedActionKey).toBe("agentListingConversion");
      expect(routeAgentListingConversion.json.selectedPaidAction.path).toBe("/api/agent-listing-conversion");
      expect(routeAgentListingConversion.json.selectedPaidAction.maxAmountRequired).toBe("1000");
      expect(routeAgentListingConversion.json.selectedFirstPaidAction.path).toBe("/api/agent-listing-conversion");
      expect(routeAgentListingConversion.json.command).toContain("/api/agent-listing-conversion");
      ...
      expect(routeMarketplaceListingConversion.json.selectedPaidAction.path).toBe("/api/marketplace-listing-conversion-api");
      ...
      expect(localDiscoverySearch.json.genericRecommendedPaidSequence[1].use).toBe("fullRoast");
      ...
      expect(localDiscoveryFullRoastSearch.json.resources[0].metadata.id).toBe("listing_roast");
      expect(localDiscoveryFullRoastSearch.json.startHere.use).toBe("fullRoast");
      expect(localDiscoveryFullRoastSearch.json.startHere.path).toBe("/api/listing-roast");
      expect(localDiscoveryFullRoastSearch.json.startHere.method).toBe("POST");
      ...
      expect(localDiscoveryFullRoastSearch.json.recommendedPaidSequence[0].use).toBe("fullRoast");
      ...
      expect(cashRegister.json.signals.routeViews).toBe(22);
  ...
  it("serves common agent docs and OpenAPI aliases without payment", async () => {
    ...
    try {
      ...
      expect(paymentAlias.json.metadataVersion).toBe("2026-06-20-agent-conversion-search-v1");
  ...
  it("protects the agent listing conversion alias with a one-tenth-cent x402 challenge", async () => {
    ...
    try {
      ...
      expect(challenge.resource.description).toMatch(/^agent listing conversion score/);
      expect(challenge.resource.description).toContain("$0.001");
  ...
  it("protects the indexed listing-roast GET route with a one-tenth-cent x402 challenge", async () => {
    ...
    try {
      ...
      expect(challenge.error).toBe("Payment required");
      expect(challenge.resource.url).toContain("/api/listing-roast");
      expect(challenge.resource.description).toMatch(/^Listing Roast Quick Score/);
      ...
      expect(challenge.resource.description).toContain("Listing Roast Quick Score");
