...
describe("Listing Roast x402 service", () => {
  ...
  it("records aggregate no-spend intent signals without storing raw queries", async () => {
    ...
    try {
      ...
      expect(findDiscovery.json.metadataVersion).toBe("2026-06-21-directory-post-conversion-v73");
      ...
      expect(routeFullRoast.json.metadataVersion).toBe("2026-06-21-directory-post-conversion-v73");
      expect(routeFullRoast.json.metadata_version).toBe("2026-06-21-directory-post-conversion-v73");
      ...
      expect(localDiscovery.json.metadataVersion).toBe("2026-06-21-directory-post-conversion-v73");
      expect(localDiscovery.json.metadata_version).toBe("2026-06-21-directory-post-conversion-v73");
      ...
      expect(localDiscovery.json.resources[0].metadataVersion).toBe("2026-06-21-directory-post-conversion-v73");
      expect(localDiscovery.json.resources[0].metadata_version).toBe("2026-06-21-directory-post-conversion-v73");
      expect(localDiscovery.json.resources[0].metadata.serviceName).toBe("Listing Roast x402");
      expect(localDiscovery.json.resources[0].metadata.metadata_version).toBe("2026-06-21-directory-post-conversion-v73");
  ...
  it("serves public metadata without payment", async () => {
    ...
    try {
      ...
      expect(mcp.json.metadataVersion).toBe("2026-06-21-directory-post-conversion-v73");
      expect(mcp.json.metadata_version).toBe("2026-06-21-directory-post-conversion-v73");
      expect(mcp.json.metadataUpdatedAt).toBe("2026-06-21T03:51:14.000Z");
      expect(mcp.json.metadata_updated_at).toBe("2026-06-21T03:51:14.000Z");
      ...
      expect(mcpRootAlias.json.mcpJsonRpcToolCards.map((tool) => tool.name).slice(0, 3)).toEqual(["search_resources", "proxy_tool_call", "listing_roast_x402_handoff"]);
      expect(mcpRootAlias.json.mcpJsonRpcToolCards[0].endpoint).toBe("http://localhost:8787/mcp");
      expect(mcpRootAlias.json.mcpJsonRpcToolCards[0].noSpend).toBe(true);
      expect(mcpRootAlias.json.mcpJsonRpcToolCards[0].callExample.params.name).toBe("search_resources");
      expect(mcpRootAlias.json.mcpJsonRpcToolCards[0].callExample.params.arguments.query).toBe("AgentCore x402 payments");
      expect(mcpRootAlias.json.mcpJsonRpcToolCards[1].paymentRule).toContain("does not execute paid calls");
      expect(mcpRootAlias.json.toolRouting.firstNoSpendTool).toBe("search_resources");
      expect(mcpRootAlias.json.toolRouting.paidHandoffTool).toBe("proxy_tool_call");
      ...
      expect(mcpInitialize.json.result.serverInfo.version).toBe("2026-06-21-directory-post-conversion-v73");
      ...
      expect(mcpHandoff.json.result.structuredContent.exactIntentCommand).toContain("/api/buyer-agent-skip-reasons");
      expect(mcpHandoff.json.result.structuredContent.catalogRefreshCommand).toContain("/api/buyer-agent-skip-reasons");
      expect(mcpHandoff.json.result.structuredContent.catalogRefreshInstruction).toContain("Do not self-pay");
      expect(mcpHandoff.json.result.structuredContent.exactIntentCommandChoice.noSelfPay).toBe(true);
      ...
      expect(mcpSearchResources.json.result.structuredContent.selectedActionKey).toBe("agentCoreX402Payments");
      expect(mcpSearchResources.json.result.structuredContent.selectedFirstPaidAction.path).toBe("/api/listing-roast");
      expect(mcpSearchResources.json.result.structuredContent.exactIntentPaidAction.path).toBe("/api/agentcore-x402-payments");
      expect(mcpSearchResources.json.result.structuredContent.exactIntentCommand).toContain("/api/agentcore-x402-payments");
      expect(mcpSearchResources.json.result.structuredContent.catalogRefreshCommand).toContain("/api/agentcore-x402-payments");
      expect(mcpSearchResources.json.result.structuredContent.catalogRefreshInstruction).toContain("Do not self-pay");
      expect(mcpSearchResources.json.result.structuredContent.exactIntentCommandChoice.firstPaidPath).toBe("/api/listing-roast");
      expect(mcpSearchResources.json.result.structuredContent.exactIntentCommandChoice.exactIntentPaidPath).toBe("/api/agentcore-x402-payments");
      ...
      expect(mcpProxyToolCall.json.result.structuredContent.exactIntentPaidAction.path).toBe("/api/buyer-agent-skip-reasons");
      expect(mcpProxyToolCall.json.result.structuredContent.exactIntentCommand).toContain("/api/buyer-agent-skip-reasons");
      expect(mcpProxyToolCall.json.result.structuredContent.catalogRefreshCommand).toContain("/api/buyer-agent-skip-reasons");
      expect(mcpProxyToolCall.json.result.structuredContent.catalogRefreshInstruction).toContain("Do not self-pay");
      ...
      expect(mcpServerCard.json.metadataVersion).toBe("2026-06-21-directory-post-conversion-v73");
      expect(mcpServerCard.json.metadata_version).toBe("2026-06-21-directory-post-conversion-v73");
      expect(mcpServerCard.json.metadataUpdatedAt).toBe("2026-06-21T03:51:14.000Z");
      expect(mcpServerCard.json.metadata_updated_at).toBe("2026-06-21T03:51:14.000Z");
      expect(mcpServerCard.json.serverInfo.name).toBe("Listing Roast x402");
      expect(mcpServerCard.json.serverInfo.version).toBe("2026-06-21-directory-post-conversion-v73");
      expect(mcpServerCard.json.transport).toBe("http");
      expect(mcpServerCard.json.jsonRpcEndpoint).toContain("/mcp");
      expect(mcpServerCard.json.tools.map((tool) => tool.name).slice(0, 3)).toEqual(["search_resources", "proxy_tool_call", "listing_roast_x402_handoff"]);
      expect(mcpServerCard.json.tools[0].endpoint).toBe("http://localhost:8787/mcp");
      expect(mcpServerCard.json.tools[0].noSpend).toBe(true);
      expect(mcpServerCard.json.tools[0].callExample.params.arguments.query).toBe("AgentCore x402 payments");
      expect(mcpServerCard.json.mcpJsonRpcToolCards[1].callExample.params.name).toBe("proxy_tool_call");
      expect(mcpServerCard.json.toolRouting.buyerInstruction).toContain("Use search_resources first");
      ...
      expect((await compressedX402Manifest.json()).metadataVersion).toBe("2026-06-21-directory-post-conversion-v73");
      ...
      expect(x402Manifest.json.metadataVersion).toBe("2026-06-21-directory-post-conversion-v73");
      expect(x402Manifest.json.metadataUpdatedAt).toBe("2026-06-21T03:51:14.000Z");
      ...
      expect(publicCdpSearchAudit.observedAt).toBe("2026-06-21T03:18:07.000Z");
      ...
      expect(publicCdpSearchAudit.missingOrCompetedQueries.find((entry) => entry.query === "buyer-agent skip reasons").observedTopResult).toContain("no public CDP results");
      expect(publicCdpSearchAudit.missingOrCompetedQueries.find((entry) => entry.query === "AgentCore x402 payments").observedTopResult).toContain("agent wallet fund");
      ...
      expect(agentTools.json.metadataVersion).toBe("2026-06-21-directory-post-conversion-v73");
      expect(agentTools.json.metadata_version).toBe("2026-06-21-directory-post-conversion-v73");
      expect(agentTools.json.metadataUpdatedAt).toBe("2026-06-21T03:51:14.000Z");
      expect(agentTools.json.metadata_updated_at).toBe("2026-06-21T03:51:14.000Z");
      ...
      expect(agentCard.json.metadataVersion).toBe("2026-06-21-directory-post-conversion-v73");
      expect(agentCard.json.metadata_version).toBe("2026-06-21-directory-post-conversion-v73");
      expect(agentCard.json.metadataUpdatedAt).toBe("2026-06-21T03:51:14.000Z");
      expect(agentCard.json.metadata_updated_at).toBe("2026-06-21T03:51:14.000Z");
      ...
      expect(agentSkills.json.metadataVersion).toBe("2026-06-21-directory-post-conversion-v73");
      expect(agentSkills.json.metadata_version).toBe("2026-06-21-directory-post-conversion-v73");
      expect(agentSkills.json.metadataUpdatedAt).toBe("2026-06-21T03:51:14.000Z");
      expect(agentSkills.json.metadata_updated_at).toBe("2026-06-21T03:51:14.000Z");
      ...
      expect(examples.json.payNow.metadataVersion).toBe("2026-06-21-directory-post-conversion-v73");
      ...
      expect(payNow.json.metadataVersion).toBe("2026-06-21-directory-post-conversion-v73");
      expect(payNow.json.metadata_version).toBe("2026-06-21-directory-post-conversion-v73");
      expect(payNow.json.metadataUpdatedAt).toBe("2026-06-21T03:51:14.000Z");
      expect(payNow.json.metadata_updated_at).toBe("2026-06-21T03:51:14.000Z");
      ...
      expect(payNow.json.paidUsageProof.metadataVersion).toBe("2026-06-21-directory-post-conversion-v73");
      expect(payNow.json.paidUsageProof.metadata_version).toBe("2026-06-21-directory-post-conversion-v73");
      expect(payNow.json.paidUsageProof.metadataUpdatedAt).toBe("2026-06-21T03:51:14.000Z");
      expect(payNow.json.paidUsageProof.metadata_updated_at).toBe("2026-06-21T03:51:14.000Z");
      ...
      expect(paidUsageProof.json.metadataVersion).toBe("2026-06-21-directory-post-conversion-v73");
      expect(paidUsageProof.json.metadata_version).toBe("2026-06-21-directory-post-conversion-v73");
      expect(paidUsageProof.json.metadataUpdatedAt).toBe("2026-06-21T03:51:14.000Z");
      expect(paidUsageProof.json.metadata_updated_at).toBe("2026-06-21T03:51:14.000Z");
      ...
      expect(paidUsageProof.json.paidUsageProof.metadataVersion).toBe("2026-06-21-directory-post-conversion-v73");
      expect(paidUsageProof.json.paidUsageProof.metadata_version).toBe("2026-06-21-directory-post-conversion-v73");
      expect(paidUsageProof.json.paidUsageProof.metadataUpdatedAt).toBe("2026-06-21T03:51:14.000Z");
      expect(paidUsageProof.json.paidUsageProof.metadata_updated_at).toBe("2026-06-21T03:51:14.000Z");
      ...
      expect(commands.json.exactIntentCommand).toContain("/api/paid-api-listing-quality");
      expect(commands.json.catalogRefreshCommand).toContain("/api/paid-api-listing-quality");
      expect(commands.json.catalogRefreshInstruction).toContain("Do not self-pay");
      expect(commands.json.exactIntentExpectedChallenge.amount).toBe("1000");
      expect(commands.json.exactIntentCommandChoice.firstPaidPath).toBe("/api/listing-roast");
      expect(commands.json.exactIntentCommandChoice.exactIntentPaidPath).toBe("/api/paid-api-listing-quality");
      ...
      const commandsSkipReasons = await fetchJson(server, "/api/commands?intent=buyer-agent%20skip%20reasons");
      expect(commandsSkipReasons.status).toBe(200);
      expect(commandsSkipReasons.headers.get("payment-required")).toBeNull();
      expect(commandsSkipReasons.json.noSpend).toBe(true);
      expect(commandsSkipReasons.json.selectedActionKey).toBe("buyerAgentSkipReasons");
      expect(commandsSkipReasons.json.command).toContain("/api/listing-roast");
      expect(commandsSkipReasons.json.firstPaidCommand).toContain("/api/listing-roast");
      expect(commandsSkipReasons.json.exactIntentPaidAction.path).toBe("/api/buyer-agent-skip-reasons");
      expect(commandsSkipReasons.json.exactIntentCommand).toContain("/api/buyer-agent-skip-reasons");
      expect(commandsSkipReasons.json.catalogRefreshPaidAction.path).toBe("/api/buyer-agent-skip-reasons");
      expect(commandsSkipReasons.json.catalogRefreshCommand).toContain("/api/buyer-agent-skip-reasons");
      expect(commandsSkipReasons.json.catalogRefreshExpectedChallenge.amount).toBe("1000");
      expect(commandsSkipReasons.json.catalogRefreshInstruction).toContain("Do not self-pay");
      expect(commandsSkipReasons.json.exactIntentCommandChoice.noSelfPay).toBe(true);
      expect(commandsSkipReasons.json.exactIntentCommandChoice.firstPaidPath).toBe("/api/listing-roast");
      expect(commandsSkipReasons.json.exactIntentCommandChoice.exactIntentPaidPath).toBe("/api/buyer-agent-skip-reasons");
      ...
      expect(payNowSkipReasons.json.exactIntentCommand).toContain("/api/buyer-agent-skip-reasons");
      expect(payNowSkipReasons.json.exactIntentExpectedChallenge.amount).toBe("1000");
      expect(payNowSkipReasons.json.catalogRefreshPaidAction.path).toBe("/api/buyer-agent-skip-reasons");
      expect(payNowSkipReasons.json.catalogRefreshCommand).toContain("/api/buyer-agent-skip-reasons");
      expect(payNowSkipReasons.json.catalogRefreshInstruction).toContain("Do not self-pay");
      expect(payNowSkipReasons.json.exactIntentCommandChoice.firstPaidPath).toBe("/api/listing-roast");
      expect(payNowSkipReasons.json.exactIntentCommandChoice.exactIntentPaidPath).toBe("/api/buyer-agent-skip-reasons");
      ...
      expect(payNowPaidApiListingQuality.json.metadataVersion).toBe("2026-06-21-directory-post-conversion-v73");
      ...
      expect(payNowDirectoryPost.json.paidResponsePreview.example.includedQuickScore).toBeTruthy();
      ...
      expect(pricing.json.metadataVersion).toBe("2026-06-21-directory-post-conversion-v73");
      expect(pricing.json.metadata_version).toBe("2026-06-21-directory-post-conversion-v73");
      expect(pricing.json.metadataUpdatedAt).toBe("2026-06-21T03:51:14.000Z");
      expect(pricing.json.metadata_updated_at).toBe("2026-06-21T03:51:14.000Z");
      expect(pricing.json.noSpend).toBe(true);
      expect(pricing.json.paidUsageProof.serviceName).toBe("Listing Roast x402");
      expect(pricing.json.paidUsageProof.metadata_version).toBe("2026-06-21-directory-post-conversion-v73");
      ...
      expect(findSkipReasons.json.catalogRefreshCommand).toContain("/api/buyer-agent-skip-reasons");
      expect(findSkipReasons.json.catalogRefreshInstruction).toContain("Do not self-pay");
      ...
      expect(routeDiscovery.json.metadataVersion).toBe("2026-06-21-directory-post-conversion-v73");
      expect(routeDiscovery.json.metadata_version).toBe("2026-06-21-directory-post-conversion-v73");
      ...
      expect(routeDiscovery.json.results[0].metadataVersion).toBe("2026-06-21-directory-post-conversion-v73");
      expect(routeDiscovery.json.results[0].metadata_version).toBe("2026-06-21-directory-post-conversion-v73");
      ...
      expect(localDiscovery.json.metadataVersion).toBe("2026-06-21-directory-post-conversion-v73");
      expect(localDiscovery.json.metadata_version).toBe("2026-06-21-directory-post-conversion-v73");
      expect(localDiscovery.json.metadataUpdatedAt).toBe("2026-06-21T03:51:14.000Z");
      expect(localDiscovery.json.metadata_updated_at).toBe("2026-06-21T03:51:14.000Z");
      ...
      expect(localDiscovery.json.items[0].metadataVersion).toBe("2026-06-21-directory-post-conversion-v73");
      expect(localDiscovery.json.items[0].metadata_version).toBe("2026-06-21-directory-post-conversion-v73");
      expect(localDiscovery.json.items[0].metadataUpdatedAt).toBe("2026-06-21T03:51:14.000Z");
      expect(localDiscovery.json.items[0].metadata_updated_at).toBe("2026-06-21T03:51:14.000Z");
      ...
      expect(localDiscovery.json.items[0].metadata.metadataVersion).toBe("2026-06-21-directory-post-conversion-v73");
      expect(localDiscovery.json.items[0].metadata.metadata_version).toBe("2026-06-21-directory-post-conversion-v73");
      expect(localDiscovery.json.items[0].metadata.metadataUpdatedAt).toBe("2026-06-21T03:51:14.000Z");
      expect(localDiscovery.json.items[0].metadata.metadata_updated_at).toBe("2026-06-21T03:51:14.000Z");
      ...
      expect(localDiscoverySearch.json.metadataVersion).toBe("2026-06-21-directory-post-conversion-v73");
      expect(localDiscoverySearch.json.metadata_version).toBe("2026-06-21-directory-post-conversion-v73");
      ...
      expect(localDiscoverySearch.json.resources[0].metadata_version).toBe("2026-06-21-directory-post-conversion-v73");
      ...
      expect(localDiscoverySearch.json.resources[0].metadata.metadata_version).toBe("2026-06-21-directory-post-conversion-v73");
      ...
      expect(localDiscoveryMerchant.json.metadataVersion).toBe("2026-06-21-directory-post-conversion-v73");
      expect(localDiscoveryMerchant.json.metadata_version).toBe("2026-06-21-directory-post-conversion-v73");
      ...
      expect(localDiscoveryMerchant.json.resources[0].metadata_version).toBe("2026-06-21-directory-post-conversion-v73");
      ...
      expect(cashRegister.json.signals.commandsViews).toBe(15);
  ...
  it("includes receiver wallet proof on the free paid usage proof endpoint", async () => {
    ...
    try {
      ...
      expect(proof.json.metadata_version).toBe("2026-06-21-directory-post-conversion-v73");
      ...
      expect(proof.json.paidUsageProof.metadata_version).toBe("2026-06-21-directory-post-conversion-v73");
      ...
      expect(payNowFirstPaid.json.metadata_version).toBe("2026-06-21-directory-post-conversion-v73");
  ...
  it("serves common agent docs and OpenAPI aliases without payment", async () => {
    ...
    try {
      ...
      expect(paymentAlias.json.metadataVersion).toBe("2026-06-21-directory-post-conversion-v73");
  ...
  it("protects the public directory root POST handoff with a one-tenth-cent x402 challenge", async () => {
    ...
    try {
      ...
      expect(challenge.resource.description).toContain("already received this POST / x402 challenge");
      expect(challenge.resource.description).toContain("immediate quick score plus route map");
      ...
      expect(response.json.directoryPostConversionHint.cleanFirstPaidAction.path).toBe("/api/listing-roast");
      expect(response.json.directoryPostConversionHint.whenToPayFallback).toContain("already followed a stale generic directory snippet");
      expect(response.json.directoryPostConversionHint.whenToUseCleanRoute).toContain("GET /api/listing-roast");
      expect(response.json.directoryPostConversionHint.paidFallbackOutput).toContain("includedQuickScore");
      expect(response.json.directoryPostConversionHint.buyerInstruction).toContain("capped at 1000");
