...
describe("Listing Roast x402 service", () => {
  it("serves public metadata without payment", async () => {
    ...
    try {
      ...
      expect(x402Manifest.json.metadataVersion).toBe("2026-06-20-indexed-route-search-frontload-v1");
      expect(x402Manifest.json.metadataUpdatedAt).toBe("2026-06-20T01:48:24.000Z");
      ...
      expect(x402Manifest.json.resources[0].description).toMatch(/^Paid API listing quality score and buyer-agent skip reasons/);
      ...
      expect(agentTools.json.metadata_version).toBe("2026-06-20-indexed-route-search-frontload-v1");
      expect(agentTools.json.metadata_updated_at).toBe("2026-06-20T01:48:24.000Z");
      ...
      expect(agentSkills.json.metadataVersion).toBe("2026-06-20-indexed-route-search-frontload-v1");
      ...
      expect(openApi.json.paths["/api/listing-roast"].get.description).toContain("Paid API listing quality score and buyer-agent skip reasons");
  ...
  it("serves common agent docs and OpenAPI aliases without payment", async () => {
    ...
    try {
      ...
      expect(paymentAlias.json.metadataVersion).toBe("2026-06-20-indexed-route-search-frontload-v1");
  ...
  it("protects the indexed listing-roast GET route with a one-tenth-cent x402 challenge", async () => {
    ...
    try {
      ...
      expect(challenge.error).toBe("Payment required");
      expect(challenge.resource.url).toContain("/api/listing-roast");
      expect(challenge.resource.description).toMatch(/^Paid API listing quality score and buyer-agent skip reasons/);
      expect(challenge.resource.description).toContain("$0.001");
