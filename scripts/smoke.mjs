...
const defaultGetPaths = new Set(["/api", "/api/v1", "/v1", "/api/listing-roast", ...quickScoreAliasPaths, "/api/instant-listing-score", "/api/x402-marketplace-conversion", "/api/agent-listing-conversion", "/api/agent-listing-conversion-score", "/api/x402-ping", "/api/x402-site-audit", "/api/x402-discovery-audit", "/api/agent402-route-visibility"]);
